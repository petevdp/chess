...
import { SocketClientMessage, UserDetails, CompleteGameInfo } from "../../common/types"
...
export function getLobbyMemberConnectionPair (
  ...
  const member = new LobbyMember(clientConnection as unknown as ClientConnection, activeGames)
